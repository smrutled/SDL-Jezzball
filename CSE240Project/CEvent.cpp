...
void CEvent::Input(SDL_Event* Event) {
    switch(Event->type) {
        ...
        case SDL_KEYDOWN: {
            OnKeyDown(Event->key.keysym.sym,(SDL_Keymod)Event->key.keysym.mod,Event->key.keysym.unicode);
            break;
        }
 
        case SDL_KEYUP: {
            OnKeyUp(Event->key.keysym.sym,(SDL_Keymod)Event->key.keysym.mod,Event->key.keysym.unicode);
            break;
        }
